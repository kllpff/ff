...
<a href="<?php echo route('home'); ?>">Главная</a>
<a href="<?php echo route('blog.index'); ?>">Блог</a>
<a href="<?php echo route('blog.show', ['slug' => $post->slug]); ?>">Пост</a>
<a href="<?php echo route('profile'); ?>">Профиль</a>
```
